  ...
  return (
    <div className={["min-h-screen flex flex-col", className].filter(Boolean).join(' ')}>
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link 
              ...
              className="hidden md:inline-flex items-center rounded-md bg-black text-white px-3 py-1.5 text-sm dark:bg-white dark:text-black"
            >
              Join Waveful
            </Link>
          </div>
      ...
      <footer className="border-t border-gray-200">
        <div className="mx-auto w-full max-w-7xl px-4 py-6 text-sm">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-center sm:text-left">
              <div className="font-medium">LuckyUI</div>
              <div className="text-gray-600 dark:text-gray-300">made with ❤️ by <Link target='_blank' href="https://waveful.com">Waveful</Link></div>
            </div>
